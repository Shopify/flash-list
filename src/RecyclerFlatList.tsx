...
class RecyclerFlatList<T> extends React.PureComponent<RecyclerFlatListProps<T>, RecyclerFlatListState<T>> {
  ...
  static getDerivedStateFromProps<T>(nextProps: RecyclerFlatListProps<T>, prevState: RecyclerFlatListState<T>): RecyclerFlatListState<T> {
    ...
    if (nextProps.data !== prevState.data) {
      ...
      newState.dataProvider = newState.dataProvider.cloneWithRows(nextProps.data as any[])
    }
    return newState;
  }

  static getInitialState<T>(props: RecyclerFlatListProps<T>): RecyclerFlatListState<T> {
    ...
    return { numColumns, layoutProvider: RecyclerFlatList.getLayoutProvider(numColumns, sizeProvider), dataProvider: dataProvider.cloneWithRows(props.data as any[]), data: props.data };
  }
